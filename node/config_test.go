...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "sdvn.ipc", false, filepath.Join(os.TempDir(), "sdvn.ipc")},
		{"data", "sdvn.ipc", false, "data/sdvn.ipc"},
		{"data", "./sdvn.ipc", false, "./sdvn.ipc"},
		{"data", "/sdvn.ipc", false, "/sdvn.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "sdvn.ipc", true, `\\.\pipe\sdvn.ipc`},
		{"data", "sdvn.ipc", true, `\\.\pipe\sdvn.ipc`},
		{"data", `\\.\pipe\sdvn.ipc`, true, `\\.\pipe\sdvn.ipc`},
	}
