...
// all blocks' seal as valid, though they still have to conform to the sdvn
// consensus rules.
...
// still have to conform to the sdvn consensus rules.
...
// they still have to conform to the sdvn consensus rules.
