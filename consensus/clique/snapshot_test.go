...
// mapped from textual names used in the tests below to actual sdvn private
...
// address retrieves the sdvn address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the sdvn address
