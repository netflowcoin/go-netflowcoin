Name "sdvn ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/seaskycheng/sdvn/issues"
!define UPDATEURL "https://github.com/seaskycheng/sdvn/releases"
!define ABOUTURL "https://github.com/seaskycheng/sdvn#sdvn"
...
# Install sdvn binary
Section "sdvn" SDVN_IDX
  SetOutPath $INSTDIR
  file {{.sdvn}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\sdvn.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\sdvn.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "sdvn incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "sdvn outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "sdvn UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "sdvn incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\sdvn.exe" "" "" "sdvn" 30303 "" "" ""
  SimpleFC::AdvAddRule "sdvn outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\sdvn.exe" "" "" "sdvn" "" 30303 "" ""
  SimpleFC::AdvAddRule "sdvn UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\sdvn.exe" "" "" "sdvn" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "SDVN_SOCKET" "R" "HKLM" "\\.\pipe\sdvn.ipc"
  ${EnvVarUpdate} $0 "SDVN_SOCKET" "A" "HKLM" "\\.\pipe\sdvn.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${SDVN_IDX}
    SectionGetSize ${SDVN_IDX} $0
