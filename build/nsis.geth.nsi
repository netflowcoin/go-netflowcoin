...
# 1. install sdvn for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for sdvn
# 5. create sdvn, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable SDVN_SOCKET
...
!define GROUPNAME "sdvn"
!define APPNAME "sdvn"
!define DESCRIPTION "Official Go implementation of the sdvn protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since sdvn is installed global
