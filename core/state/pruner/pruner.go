...
pruning. Remember don't start the sdvn. without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "sdvn. snapshot prune-state --help" for more details.
`
