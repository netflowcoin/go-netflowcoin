...
// stateObject represents an sdvn account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of sdvn address of the account
	data     Account
	db       *StateDB
...
// Account is the sdvn consensus representation of accounts.
