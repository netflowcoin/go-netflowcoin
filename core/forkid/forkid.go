...
// NewID calculates the sdvn fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the sdvn fork ID from an existing chain instance.
