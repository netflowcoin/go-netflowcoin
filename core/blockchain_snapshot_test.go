...
// It can be used for testing that restart sdvn. normally.
...
// It can be used for testing that restart sdvn. after the crash.
...
// Tests a sdvn. restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a sdvn. was crashed and restarts with a broken snapshot. In this case the
...
// Tests a sdvn. was crashed and restarts with a broken snapshot. In this case
...
// Tests a sdvn. was running with snapshot enabled. Then restarts without
...
// Tests the sdvn. was running with snapshot enabled and resetHead is applied.
...
// Tests the sdvn. was running with a complete snapshot and then imports a few
