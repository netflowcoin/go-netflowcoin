...
// Package types contains data types related to sdvn consensus.
package types
...
// Header represents a block header in the sdvn blockchain.
type Header struct {
...
// Block represents an entire block in the sdvn blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the sdvn RLP block format.
