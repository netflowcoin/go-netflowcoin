...
import (
	...
	"github.com/seaskycheng/sdvn/internal/jsre"
	"github.com/seaskycheng/sdvn/internal/jsre/deps"
	"github.com/seaskycheng/sdvn/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute sdvn requests through
...
// Welcome show summary of current sdvn instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the sdvn JavaScript console!\n\n"

	// Print some generic sdvn metadata
