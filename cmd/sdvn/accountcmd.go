...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage sdvn presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    sdvn wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import sdvn presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	sdvn wallet [options] /path/to/my/presale.wallet
...
between sdvn nodes by simply copying.
...
For non-interactive use the password can be specified with the --password flag:
    ...
    sdvn account update [options] <address>
...
For non-interactive use the password can be specified with the -password flag:
    ...
    sdvn account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another sdvn instance,
