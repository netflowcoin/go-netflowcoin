...
import (
	...
	"github.com/seaskycheng/sdvn/signer/fourbyte"
	"github.com/seaskycheng/sdvn/signer/rules"
	"github.com/seaskycheng/sdvn/signer/storage"
...
func init() {
	app.Name = "Clef"
	app.Usage = "Manage sdvn account operations"
	app.Flags = []cli.Flag{
		logLevelFlag,
		keystoreFlag,
		configdirFlag,
