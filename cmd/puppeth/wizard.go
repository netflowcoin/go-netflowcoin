...
type wizard struct {
	...
	services map[string][]string   // sdvn services known to be running on servers
...
// converts it to an sdvn address. If an empty line is entered, the default
// value is returned.
