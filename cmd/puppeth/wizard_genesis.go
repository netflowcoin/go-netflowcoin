...
// importGenesis imports a sdvn genesis spec into puppeth.
...
func (w *wizard) manageGenesis() {
	...
	case "2":
		...
		// Export the native genesis spec used by puppeth and sdvn
		...
		// Export the genesis spec used by Aleth (formerly C++ sdvn)
		...
		// Export the genesis spec used by Harmony (formerly sdvnJ)
