...
// setting up a new or managing an existing sdvn private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your sdvn private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new sdvn network down to  |")
	...
	log.Info("Administering sdvn network", "name", w.network)
