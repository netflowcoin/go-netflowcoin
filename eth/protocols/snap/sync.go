...
import (
	...
	"github.com/seaskycheng/sdvn/p2p/msgrate"
...
// Syncer is an sdvn account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the sdvn state over the
// snap protocol.
