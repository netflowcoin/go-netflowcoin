...
import (
	...
	"github.com/seaskycheng/sdvn/signer/core"
)
...
func (api *ExternalSigner) SelfDerive(bases []accounts.DerivationPath, chain sdvn.ChainStateReader) {
...
func (api *ExternalSigner) SignText(account accounts.Account, text []byte) ([]byte, error) {
	...
	if signature[64] == 27 || signature[64] == 28 {
		...
		// the signature to sdvn-type signature.
		signature[64] -= 27 // Transform V from sdvn-legacy to 0/1
	}
