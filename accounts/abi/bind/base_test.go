...
func (mc *mockCaller) CallContract(ctx context.Context, call sdvn.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (mc *mockCaller) PendingCallContract(ctx context.Context, call sdvn.CallMsg) ([]byte, error) {
